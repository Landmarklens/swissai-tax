"""Appenzell Ausserrhoden Canton Wealth Tax Calculator

Official Source: https://ar.ch/
Tax Year: 2024
...
class AppenzellAusserrhodenWealthTaxCalculator(ProgressiveWealthTaxCalculator):
    """Appenzell Ausserrhoden Canton Wealth Tax Calculator - Progressive Structure"""
    ...
    def _load_brackets(self) -> list:
        ...
        return [
            (Decimal('500000'), Decimal('1.1')),
            (Decimal('1500000'), Decimal('1.6')),
            (None, Decimal('2.1')),  # Top bracket
        ]
