"""Jura Canton Wealth Tax Calculator

Official Source: https://www.jura.ch/
Tax Year: 2024
...
class JuraWealthTaxCalculator(ProgressiveWealthTaxCalculator):
    """Jura Canton Wealth Tax Calculator - Progressive Structure"""
