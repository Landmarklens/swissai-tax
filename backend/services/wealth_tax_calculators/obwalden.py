"""Obwalden Canton Wealth Tax Calculator

Official Source: https://www.ow.ch/
Tax Year: 2024
...
class ObwaldenWealthTaxCalculator(ProgressiveWealthTaxCalculator):
    """Obwalden Canton Wealth Tax Calculator - Progressive Structure"""
    ...
    def _load_brackets(self) -> list:
        ...
        return [
            ...
            (Decimal('1500000'), Decimal('1.0')),
            (None, Decimal('1.4')),  # Top bracket
        ]
