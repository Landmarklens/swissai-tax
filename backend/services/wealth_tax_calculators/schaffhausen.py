"""Schaffhausen Canton Wealth Tax Calculator

Official Source: https://sh.ch/
Tax Year: 2024
...
class SchaffhausenWealthTaxCalculator(ProgressiveWealthTaxCalculator):
    """Schaffhausen Canton Wealth Tax Calculator - Progressive Structure"""
    ...
    def _load_brackets(self) -> list:
        ...
        return [
            (Decimal('200000'), Decimal('0.9')),
            (Decimal('500000'), Decimal('1.2')),
            (Decimal('1000000'), Decimal('1.5')),
            (Decimal('2000000'), Decimal('1.8')),
            (None, Decimal('2.3')),  # Top bracket
        ]
