"""Thurgau Canton Wealth Tax Calculator

Official Source: https://steuerverwaltung.tg.ch/
Tax Year: 2024
...
class ThurgauWealthTaxCalculator(ProgressiveWealthTaxCalculator):
    """Thurgau Canton Wealth Tax Calculator - Progressive Structure"""
    ...
    def _load_brackets(self) -> list:
        ...
        return [
            ...
            (Decimal('1500000'), Decimal('1.7')),
            (None, Decimal('2.2')),  # Top bracket
        ]
