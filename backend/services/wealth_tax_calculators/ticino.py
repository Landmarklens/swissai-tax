"""Ticino Canton Wealth Tax Calculator

Official Source: https://www4.ti.ch/dfe/dc/
Tax Year: 2024
...
class TicinoWealthTaxCalculator(ProgressiveWealthTaxCalculator):
    """Ticino Canton Wealth Tax Calculator - Progressive Structure"""

    CANTON_CODE = "TI"
    CANTON_NAME = "Ticino"

    THRESHOLD_SINGLE = Decimal('90000')
    THRESHOLD_MARRIED = Decimal('180000')
    ...
    def _load_brackets(self) -> list:
        ...
        return [
            ...
            (Decimal('500000'), Decimal('2.5')),
            (Decimal('1000000'), Decimal('3.0')),
            (Decimal('2000000'), Decimal('3.7')),
            (None, Decimal('4.7')),  # Top bracket
        ]
