"""Valais Canton Wealth Tax Calculator

Official Source: https://www.vs.ch/web/scc/
Tax Year: 2024
...
class ValaisWealthTaxCalculator(ProgressiveWealthTaxCalculator):
    """Valais Canton Wealth Tax Calculator - Progressive Structure"""

    CANTON_CODE = "VS"
    CANTON_NAME = "Valais"

    THRESHOLD_SINGLE = Decimal('60000')
    THRESHOLD_MARRIED = Decimal('120000')
