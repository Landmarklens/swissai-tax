"""Zug Canton Wealth Tax Calculator

Official Source: https://www.zg.ch/behoerden/finanzdirektion/steuerverwaltung
Tax Year: 2024
...
class ZugWealthTaxCalculator(ProgressiveWealthTaxCalculator):
    """Zug Canton Wealth Tax Calculator - Progressive Structure"""

    CANTON_CODE = "ZG"
    CANTON_NAME = "Zug"

    THRESHOLD_SINGLE = Decimal('200000')
    THRESHOLD_MARRIED = Decimal('400000')
    ...
    def _load_brackets(self) -> list:
        ...
        return [
            (Decimal('150000'), Decimal('0.425')),
            (Decimal('300000'), Decimal('0.6')),
            (Decimal('600000'), Decimal('0.9')),
            (Decimal('1200000'), Decimal('1.2')),
