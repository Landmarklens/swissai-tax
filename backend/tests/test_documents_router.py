...
class TestGetUserStorage:
    ...
    def test_get_storage_success(self, authenticated_client, mock_current_user, mock_doc_service):
        ...
        response = authenticated_client.get('/api/documents/user/storage')
    ...
    def test_get_storage_service_error(self, authenticated_client, mock_current_user, mock_doc_service):
...
class TestGetAllUserDocuments:
    ...
    def test_get_all_documents_success(self, authenticated_client, mock_current_user, mock_doc_service):
        ...
        response = authenticated_client.get('/api/documents/user/all')
    ...
    def test_get_all_documents_empty(self, authenticated_client, mock_current_user, mock_doc_service):
...
class TestDownloadAllDocuments:
    ...
    def test_download_all_success(self, authenticated_client, mock_current_user, mock_doc_service):
        ...
        response = authenticated_client.post('/api/documents/user/download-all')
    ...
    def test_download_all_no_documents(self, authenticated_client, mock_current_user, mock_doc_service):
    ...
    def test_download_all_s3_error(self, authenticated_client, mock_current_user, mock_doc_service):
...
class TestDeleteOldDocuments:
    ...
    def test_delete_old_success(self, authenticated_client, mock_current_user, mock_doc_service):
        ...
        response = authenticated_client.delete('/api/documents/user/old')
    ...
    def test_delete_old_none_found(self, authenticated_client, mock_current_user, mock_doc_service):
    ...
    def test_delete_old_partial_failure(self, authenticated_client, mock_current_user, mock_doc_service):
...
@pytest.fixture
def authenticated_client(app, mock_current_user):
